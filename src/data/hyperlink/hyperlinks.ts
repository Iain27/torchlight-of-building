...
export const Hyperlinks: Record<string, string> = {
  ...
  "Damage Transfer":
    "Transfers a part of the Hit Damage and Secondary Damage taken to other units.\nUp to 60% of the damage taken from each hit can be transferred, and up to 90% of total damage taken can be transferred",
  ...
  "Compulsory Damage Type Conversion":
    "Converts all damage to a corresponding damage type and ignores conventional damage conversion effects.\nAdded damage is applied before damage conversion and does not conflict with this effect.",
  "Ill Omen":
    "Inflicts enemies affected by Ominous Curse with 1 stack of Ill Omen whenever their Damage Over Time, Reaping Damage, Spacetime Turbulence Damage, and additional damage taken reaches a certain percentage of their Max Life (8% for non-Elite enemies and 5% for Elite enemies)\nMaximum stacks of Ill Omen: 10\nUpon reaching max stacks, eliminates non-Elite enemies and deals True Damage equal to 20% of Max Life to Elite enemies",
  Fearless:
  ...
  Ominous:
    'Curse Skill. Gains Ill OmenInflicts enemies affected by Ominous Curse with 1 stack of Ill Omen whenever their Damage Over Time, Reaping Damage, Spacetime Turbulence Damage, and additional damage taken reaches a certain percentage of their Max Life (8% for non-Elite enemies and 5% for Elite enemies)\nMaximum stacks of Ill Omen: 10\nUpon reaching max stacks, eliminates non-Elite enemies and deals True Damage equal to 20% of Max Life to Elite enemies">Ill Omen when cursed',
  Bombard:
  ...
  Burst:
    "When triggered, deals powerful area explosion damage equal to 340% of Weapon Damage to enemies within 3m. While Dual Wielding, the Base Damage is the average damage of both weapons.\nFor every +1 to Skill Level, Burst +10% additional damage (multiplies)\nSkill Tags: Attack, Melee, Physical, Triggered, Area, Strength, Dexterity",
  Cyclone:
  ...
  Blur: "Gains 100 points of Blur Rating\n10 Blur Rating is lost per second. Blur is lost once Blur Rating drops to 0\n+0.25% Chance to Avoid Damage for every point of Blur Rating you have\nMax Blur Rating is 100",
  ...
  "Blur Rating": "每拥有 1 点迷踪值，+0.25% 几率避免伤害。迷踪值上限为100。",
  ...
  Command:
    "Equipping a skill that can summon Synthetic Troops will grant Command. Every point of Command will grant Synthetic Troop Minions +3% additional damage (+0% when Command is lower than 0), +-2% additional damage taken, ++2% Movement Speed, and a bigger Tracking Area. The lowest Command is -100 while the highest is 100. When Command is not 0, 13 points will be returned (reduced/granted) per second. For every 10 Command increased, +7 additional points returned until the total Command becomes 0.",
  "Six Gods' Blessings":
  ...
  "Reactive Rainbow":
    'For every 1% ExcessThe portion that exceeds the fixed upper limit">excess chance to avoid Elemental Ailments, +0.5% chance to deem your Max Elemental Resistance as the EffectiveThe portion that doesn\'t exceed the fixed upper limit">effective Elemental Resistance\nFor every 1% ExcessThe portion that exceeds the fixed upper limit">excess chance to avoid Elemental Ailments, +0.5% chance to inflict Elemental Resistance ReversalChanges the enemy\'s original Elemental Resistance to a corresponding negative value">Elemental Resistance Reversal on enemies when dealing Elemental Damage',
  ...
  "Tomorrow's Direction":
    "Collect 5 to exchange for random Compass x10 from the Spacetime Wanderer.",
  ...
  "Gold Fluorescent Creation Crystal":
    "A special Creation Crystal that activates all Creation Crystals of this Creation Engine when used. Its drop quantity is significantly increased",
  ...
  "Unwavering Fortress":
    "Gains Defense equal to 1.5% of Armor and absorbs 100% of Non-True Damage taken every 10s. Defense is refreshed when gained again\nMax Life is fixed at 100\nYour Evasion and Max Energy Shield are fixed at 0",
  "Unstoppable Force":
  ...
  "Miraculous Touch":
    "Triggers Miraculous GainRandomly triggers one of the following effects for 6s. This effect can be triggered up to 4 times within 1s:\nTriggers a Lv. 20 Empower Skill or Defensive Skill that might be useful\nGains 5 stacks of God of War's Blessing\nTriggers the Main Active Skill 10 times. Interval: 0.2s\nGains max stacks of Tenacity Blessing, Agility Blessing, and Focus Blessing.\nTriggers Frigid Transmission and -20% additional damage taken\n\">Miraculous Gain when casting an Elixir Skill\nElixir Skills gain 1 Charging Progress every second",
  "Dark Advance":
  ...
  "Lunar Essence":
    "The Energy required to Strum the Lunar Harp. Obtained by defeating Lunari monsters. The Lunar Harp gains 1 Strum charge when Lunar Essence reaches its limit.",
  "Lunar Ring":
    "A circular area affected by the Lunar Harp, centered at the character's feet and moving with them. Strumming activates all statues within the Lunar Ring simultaneously. Lunar Ring Radius can be increased by installing Lunar Strings.",
  "Nascent Moon":
    "A special Lunari monster that grants drops of Rare Lunari monsters but isn't affected by the Combo Bonus.",
  Rhapsody:
  ...
  "Elemental Protocol":
    'Adds 5% of Physical Damage as random ElementalFire, Cold, and Lightning">Elemental Damage and +100% Elemental AilmentIgnite, Frostbite, Freeze, and Numbed">Elemental Ailment Chance for Minions summoned by this skill',
  ...
  "Source Code: Condensation":
    'For every +1 Max FrostbiteEnemies are inflicted with a fixed amount of Frostbite Rating when they are Frostbitten. This can be increased by raising Max Frostbite Rating. The Max Frostbite Rating is 120.">Frostbite Rating, +1 Max FrostbiteEnemies are inflicted with a fixed amount of Frostbite Rating when they are Frostbitten. This can be increased by raising Max Frostbite Rating. The Max Frostbite Rating is 120.">Frostbite Rating for Minions summoned by this skill\nMinions summoned by this skill grant +30 Max Frostbite Rating to the summoner',
  ...
  "Source Code: Power Surge":
    "+500% Movement Speed for Minions summoned by this skill\n+20% additional Lightning Damage to you and allies if Minions summoned by this skill have recently moved more than 10m",
