...
export const Destinies: readonly Destiny[] = [
  ...
  },
  {
    ...
    affix:
      "+(3-5)% Skill Effect Duration\n+2% Reaping Recovery Speed for each Reaping dealt recently, up to 20%",
  },
  {
    type: "Kismet",
    name: "Growth Ring",
  ...
  },
  {
    ...
    affix:
      "Activates the following effects when there are 2 of this Kismet on the same pact page:\n+15% additional damage for Attack Horizontal Projectiles\n+5% additional Attack Speed for Mobility Skills if Attack Horizontal Projectiles have dealt damage to distant enemies recently",
  },
  {
    type: "Dual Kismet",
    name: "Mighty Arrow",
  ...
  },
  {
    ...
    name: "Sky Piercer",
    affix:
      "Activates the following effects when there are 2 of this Kismet on the same pact page:\n+20% Attack Horizontal Projectile Speed and +15% additional Attack Horizontal Projectile Damage within 5s after using a Mobility Skill",
  },
  {
    type: "Dual Kismet",
    name: "Prophet",
